...
#else
#define kOCFG_ID_PROPERTY_CONFIGURATION                     0
#define kOCFG_ID_PROPERTY_CLASS_NAME                          1
#define kOCFG_ID_PROPERTY_GET_ATTRIBUTE                      2
#define kOCFG_NUM_PROPERTY_IDENTIFIERS                       3
#endif
