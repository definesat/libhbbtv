...
} NPObj_CurrentChannel;

NPClass* fillCURRENTCHANNELpclass(void);

NPObject *  CURRENTCHANNEL_Allocate(NPP npp, NPClass *aClass);
...
bool CURRENTCHANNEL_SetProperty(NPObject *obj, NPIdentifier name, const NPVariant *value);
